...
namespace Homework.Class04
{
    class Program
    {
...

        {
            ...
            //string FunWithStrings = "The Weather is cold";
            //string subStringSentence = FunWithStrings.Substring(4);
            //int indexOfWeather = FunWithStrings.IndexOf("Weather");
            //string subStringExample2 = FunWithStrings.Substring(indexOfWeather, FunWithStrings.Length - 16);
            //Console.WriteLine(subStringExample2);
            //Console.WriteLine(subStringSentence);

            string FunWithStrings = "The Weather is cold";
            string printWord = FunWithStrings.();
